var colorLine = ['#FF0000', '#FFFF00', '#00CC00', '#0033FF', '#FF6600', '#00FFFF', '#473C8B', '#54FF9F', '#FFF68F', '#9370DB'];
...
var BieuDo = {
    ...
    MucNuocHaLuu: function () {
        ...
        $.ajax({
            type: "Post",
            data: data,
            url: "BieuDo/MucNuocHaLuu_DaTaBieuDo",
            success: function (dt) {
                var config = {
                    time: "thoi_gian",
                    data: [
    ...
    RenderChart: function (chartName, chartData, config) {
        ...
        for (var k = 0; k < configHeader.length; k++) {
            var tmpGraph = {
                ...
                "bullet": "round",
                "bulletBorderAlpha": 1,
                "bulletColor": colorLine[k],
                "bulletSize": 6,
                "valueAxis": "ax1",
                "lineColor": colorLine[k],
                "lineThickness": 2,
                "negativeLineColor": colorLine[k],
                "type": "smoothedLine",
